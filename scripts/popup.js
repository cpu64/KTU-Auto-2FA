...
window.onload = function () {
    chrome.storage.local.get(["autoLoginInfo", "auto2FA", "username", "password", "secret"], function (data) {
        if (data.autoLoginInfo != null) document.getElementById("autoLoginInfo").checked = data.autoLoginInfo;
        if (data.auto2FA != null) document.getElementById("auto2FA").checked = data.auto2FA;
        if (data.username != null) document.getElementById("usernameInput").value = data.username;
